Interactive script to use a given wav file, split it based on detected silence of given length and db, and export as many files as there are detected segments. Length and step size are in ms.
